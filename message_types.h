...
typedef enum {
    BOARD_INST_ID_CAMERA_INJ_A = 0x06,
    BOARD_INST_ID_CAMERA_INJ_B = 0x07,
    BOARD_INST_ID_CAMERA_VENT_A = 0x08,
    BOARD_INST_ID_CAMERA_VENT_B = 0x09,
    BOARD_INST_ID_CAMERA_VENT_C = 0x0A,
    BOARD_INST_ID_CAMERA_VENT_D = 0x0B,
    BOARD_INST_ID_CAMERA_RECOVERY = 0x0C,
