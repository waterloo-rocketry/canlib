...
typedef enum {
	...
	MSG_SENSOR_ALTITUDE = 0x00B,
	MSG_SENSOR_IMU_X = 0x00C,
	MSG_SENSOR_IMU_Y = 0x00D,
	MSG_SENSOR_IMU_Z = 0x00E,
	MSG_SENSOR_MAG_X = 0x00F,
	MSG_SENSOR_MAG_Y = 0x010,
	MSG_SENSOR_MAG_Z = 0x011,
	MSG_SENSOR_BARO = 0x012,
	...
	MSG_STREAM_STATUS = 0x01A,
	MSG_STREAM_DATA = 0x01B,
	MSG_STREAM_RETRY = 0x01C,
	MSG_LEDS_ON = 0x01D,
	MSG_LEDS_OFF = 0x01E,
	MSG_ID_ENUM_MAX = 0x01F
} can_msg_type_t;
...
typedef enum {
	...
	BOARD_INST_ID_CANARD_MOTOR_ENUM_MAX = 0x06
...
typedef enum {
	...
	BOARD_INST_ID_CAMERA_ENUM_MAX = 0x09
